...
pub use crate::bolts::bindings::Windows::Win32::System::Diagnostics::Debug::{SetUnhandledExceptionFilter, EXCEPTION_POINTERS, EXCEPTION_RECORD, LPTOP_LEVEL_EXCEPTION_FILTER};
...
unsafe extern "system" fn handle_exception(exception_pointers: *mut EXCEPTION_POINTERS) -> c_long {
    let code = exception_pointers
        ...
        .unwrap()
        .ExceptionCode;
    let exception_code = ExceptionCode::try_from(code as u32).unwrap();
